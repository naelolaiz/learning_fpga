// tb_riscv_singlecycle_branches.v - Verilog mirror of
// tb_riscv_singlecycle_branches.vhd. Walks every branch flavour
// (BEQ/BNE/BLT/BGE/BLTU/BGEU) taken AND not-taken; expected s0 = 4.

`timescale 1ns/1ps
`default_nettype none

module tb_riscv_singlecycle_branches;
    ...
    initial begin
        $dumpfile(`FST_OUT);
        $dumpvars(0, tb_riscv_singlecycle_branches);
    end
    ...
    initial begin
        ...
        $display("tb_riscv_singlecycle_branches simulation done!");
        sim_active = 1'b0;
        $finish;
    end
