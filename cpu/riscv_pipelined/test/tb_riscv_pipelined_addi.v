// tb_riscv_pipelined_addi.v - Verilog mirror of
// tb_riscv_pipelined_addi.vhd. Same prog_addi.hex, same shadow-
// regfile snooping, same expected t0 = 3.
//
// Doubles as the DEBUG_TRACE demo (see the VHDL twin's header for the
// full rationale). DEBUG_TRACE = 1 here switches on the per-cycle
// trace inside riscv_pipelined.v.

`timescale 1ns/1ps
`default_nettype none

module tb_riscv_pipelined_addi;
    ...
    initial begin
        $dumpfile(`FST_OUT);
        $dumpvars(0, tb_riscv_pipelined_addi);
    end
    ...
    initial begin
        ...
        $display("tb_riscv_pipelined_addi simulation done!");
        sim_active = 1'b0;
        $finish;
    end
