// tb_riscv_pipelined_loop.v - Verilog mirror of
// tb_riscv_pipelined_loop.vhd. Counted decrement loop; expected
// t0 = 0, t1 = 5.

`timescale 1ns/1ps
`default_nettype none

module tb_riscv_pipelined_loop;
    ...
    initial begin
        $dumpfile(`FST_OUT);
        $dumpvars(0, tb_riscv_pipelined_loop);
    end
    ...
    initial begin
        ...
        $display("tb_riscv_pipelined_loop simulation done!");
        sim_active = 1'b0;
        $finish;
    end
